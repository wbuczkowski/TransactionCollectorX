...
namespace TransactionCollectorX
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.Name = typeof(Program).GetTypeInfo().Assembly.GetCustomAttribute<AssemblyTitleAttribute>()?.Title;
            this.Text = typeof(Program).GetTypeInfo().Assembly.GetCustomAttribute<AssemblyTitleAttribute>()?.Title;
            this.Icon = TransactionCollectorX.Properties.Resources.AppIcon;
